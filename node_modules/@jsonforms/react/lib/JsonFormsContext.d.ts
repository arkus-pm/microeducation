import { ArrayControlProps, ArrayLayoutProps, CellProps, CombinatorRendererProps, ControlProps, DispatchCellProps, DispatchPropsOfControl, EnumCellProps, JsonFormsSubStates, LayoutProps, OwnPropsOfCell, OwnPropsOfControl, OwnPropsOfEnum, OwnPropsOfEnumCell, OwnPropsOfJsonFormsRenderer, OwnPropsOfLayout, OwnPropsOfMasterListItem, StatePropsOfControlWithDetail, StatePropsOfMasterItem, coreReducer, DispatchPropsOfMultiEnumControl } from '@jsonforms/core';
...
export declare const ctxToMultiEnumControlProps: (ctx: JsonFormsStateContext, props: OwnPropsOfControl) => import("@jsonforms/core").StatePropsOfControl & OwnPropsOfEnum;
...
export declare const ctxToJsonFormsDispatchProps: (ctx: JsonFormsStateContext, ownProps: OwnPropsOfJsonFormsRenderer) => import("@jsonforms/core").StatePropsOfJsonFormsRenderer;
...
export declare const withJsonFormsLayoutProps: (Component: ComponentType<LayoutProps>, memoize?: boolean) => ComponentType<OwnPropsOfLayout>;
